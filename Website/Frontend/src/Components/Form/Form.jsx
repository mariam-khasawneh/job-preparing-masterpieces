...
//     >
//       <SFormTitle className="text-primaryIndigo text-4xl font-bold font-inter ">
//         {title}
//       </SFormTitle>
//       {formArr.map(
...
//       {formArr.map(
//         (
//           { label, name, type, value, onChange, placeholder, className },
//           index
//         ) => (
//           <SFormControl key={index} className="flex flex-col">
//             <SLable htmlFor={name} className="text-slate-500">
...
//             </SLable>
//             <SInput
//               className={`outline-none h-10 py-0 px-4 rounded-lg border-2 place-content-center items-center focus:border-indigo-300 bg-primarybackground ${className}`}
//               autoComplete="off"
//               id={name}
//               name={name}
//               type={type}
...
//         </SAreaControl>
//       )}
//       <Button primary extraSmall type="submit" disabled={isSubmitDisabled}>
//         {submitBtn}
//       </Button>
//       {hasRedirect && (
//         <SRedirect className="text-sm font-semibold w-full flex gap-2 justify-center">
...
//   onChange: PropTypes.func,
//   withEvent: PropTypes.bool,
//   textares: PropTypes.bool,
//   textaresLabel: PropTypes.string,
...
function Form({
  ...
  const initialForm = formArr.reduce(
    (r, v) => ({ ...r, [v.name]: v.value }),
    {}
  );
      ...
      {formArr.map(
        (
          ...
          <SFormControl key={index} className="flex flex-col">
            ...
            <SInput
              className={`outline-none h-10 py-0 px-4 rounded-lg border-2 place-content-center items-center focus:border-indigo-300 text-slate-500 bg-primarybackground ${className}`}
              autoComplete="off"
              id={name}
              name={name}
              type={type}
