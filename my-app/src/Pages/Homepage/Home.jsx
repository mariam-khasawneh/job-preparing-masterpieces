      ...
      <Section className="h-screen">
        ...
        >
          <div className={styles.heroSwitcher}>
            <H6 className="text-center">Job Seeker</H6>
    ...
    <div className="flex flex-col p-4 items-stretch gap-4 rounded-2xl border-slate-200 border-2 justify-start place-content-start">
      <div className="flex gap-2">
        ...
        <div className="flex flex-col gap-0 place-content-center">
          <Caption className="leading-0 text-slate-700 text-justify	font-semibold ">
            {name}
          </Caption>
      ...
      <div>
        <Caption className="text-slate-500 text-justify	font-normal ">
          {/* The interview tips and practice questions were exactly what I needed.
          Highly recommend! */}
          {text}
        </Caption>
      </div>
